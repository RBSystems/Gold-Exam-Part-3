...
/*  
 * This namespace is meant to be used as a library for common in and out to simpl+ from any simpl# module. 
 * You write a simpl#, reference the DLL from this namespace, and then intantiate the SPIO class in your module.
 * Then in SIMPL+ you follow the standards set by this SPIO class.
*/
